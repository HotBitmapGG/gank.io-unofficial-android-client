...
import com.hotbitmapgg.studyproject.rank.utils.StringStyleUtils;
...
public class GankListAdapter extends AbsRecyclerViewAdapter
{
    ...
    public ClickableViewHolder onCreateViewHolder(ViewGroup parent, int viewType)
    {
        ...
        return new ItemViewHolder(LayoutInflater.from(getContext()).inflate(R.layout.item_gank_day, parent, false));
    }
