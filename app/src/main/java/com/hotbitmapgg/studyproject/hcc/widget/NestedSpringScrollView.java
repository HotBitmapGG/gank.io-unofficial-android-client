...
public class NestedSpringScrollView extends NestedScrollView
{
    ...
    public NestedSpringScrollView(Context context)
    {

        super(context);
    }

    public NestedSpringScrollView(Context context, AttributeSet attrs)
    {

        super(context, attrs);
    }

    public NestedSpringScrollView(Context context, AttributeSet attrs, int defStyle)
    {
...
//        contentView.startAnimation(anim);
        ...
        ObjectAnimator.ofFloat(contentView, View.TRANSLATION_Y, contentView.getTop(), originalRect.top)
