...
public class AndroidDevelopNoteContents
{
    ...
    public final static String NOTES_TWELVE_URL = "";

    public final static String NOTES_THIRTEEN_URL = "";
    ...
    public final static String NOTES_SIX_CHAPTER = "Android的Drawable（未完成）";
    ...
    public final static String NOTES_TWELVE_CHAPTER = "Bitmap的加载和Cache（未完成）";

    public final static String NOTES_THIRTEEN_CHAPTER = "综合技术、JNI与NDK编程、Android性能优化（未完成）";
