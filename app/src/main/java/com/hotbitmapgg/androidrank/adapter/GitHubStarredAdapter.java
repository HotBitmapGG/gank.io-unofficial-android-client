package com.hotbitmapgg.androidrank.adapter;
...
import com.hotbitmapgg.androidrank.utils.DateUtils;
import com.hotbitmapgg.androidrank.widget.CircleImageView;
import com.hotbitmapgg.studyproject.R;
import com.hotbitmapgg.androidrank.model.GitHubStarInfo;
...
public class GitHubStarredAdapter extends AbsRecyclerViewAdapter
{
    ...
    public ClickableViewHolder onCreateViewHolder(ViewGroup parent, int viewType)
    {
        ...
        return new ItemViewHolder(LayoutInflater.from(getContext()).inflate(R.layout.item_github_starred, parent, false));
    }
